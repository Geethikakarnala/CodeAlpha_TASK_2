...
API_KEY = 'ebd4f59714581e4a0ce7f5b8'

# the Standard request url
url = f'https://v6.exchangerate-api.com/v6/ebd4f59714581e4a0ce7f5b8/latest/USD'
...
def convert_currency():
    ...
    try:
        ...
        result = requests.get(f'https://v6.exchangerate-api.com/v6/ebd4f59714581e4a0ce7f5b8/pair/{source}/{destination}/{amount}').json()
